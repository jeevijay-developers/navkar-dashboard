...
export default function AddProduct({ onSubmit }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit({
      ...
      images: imagePreview.map((p) => p.url) || ["/clear-water-bottle.png"],
      status: formData.status === "on" ? "Published" : "Unpublished",
    })
  }
        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., Navkar Pure Water 500ml"
              required
